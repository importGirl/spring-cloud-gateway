...
public class GatewayAutoConfiguration {
	...
	/**
	 * 注解： @ConditionalOnMissingBean 当不存在 RouteDefinitionRepository bean时加载
	 * InMemoryRouteDefinitionRepository 如果我们自定义了 RouteDefinitionRepository， 就不会加载， 使用自定义的
	 * @return
	 */
	@Bean
